...
john pham - Implemented: imported the character and set up full Mecanim animation, refined PlayerController.cs for smoother movement, PauseMenu.cs, LevelComplete.cs, and parts of ScoreCounter.cs, added SFX, and edited part of EnemyAI.cs with a visual alert indicator plus improved detection and attack behavior.
